			...
			<div class="row">
				<div class="col-10">
					<button type="button" class="btn btn-success" data-toggle="modal"
						data-target="#exampleModalCenter" onclick="addUser();">新增用户</button>
					<button type="button" class="btn btn-info" data-toggle="modal"
						data-target="#exampleModalCenter" onclick="updateUser();">修改用户</button>
							...
							<div class="row">
								...
								<div class="col-md-4 ml-auto">
									<select name="u_group" class="form-control">
										<option v-for="index in 20" :value="index">{{index+1}}</option>
									</select>
								</div>
