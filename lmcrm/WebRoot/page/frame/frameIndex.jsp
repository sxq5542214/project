...
<body>
  <div class="left-side-menu" style="">
                ...
                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 661.6px;"><div class="slimscroll-menu active" id="left-side-menu-container" style="overflow: hidden; width: auto; height: 661.6px;">
                ...
                </div><div class="slimScrollBar" style="background: rgb(158, 165, 171); width: 8px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 359.963px;"></div><div class="slimScrollRail" style="width: 8px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
                <!-- Sidebar -left -->

            </div>
            
	    <div style="background-color: grey;" class="embed-responsive" id="iframeDiv" >  
	        <iframe src="wx/supplier/shop/toShopManagerIndexPage.html?sid=" id="iframPage" class="embed-responsive-item" width="100%" scrolling="yes" ></iframe>  
	    </div>
  </body>
