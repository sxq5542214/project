                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                	...
                                	<div class="row">
										...
										<div class="col">
											操作类型：
											<select name="cd_kindid" id="cd_kindid" class="form-control">
												<option value="-1">全部</option>
												<option value="0">开户</option>
												<option value="1">充值</option>
												<option value="2">充值修改</option>
												<option value="3">补卡</option>
												<option value="4">换表维护</option>
												<option value="5">过户</option>
												<option value="6">预存充值</option>
												<option value="7">用户退费</option>
											</select>
											<input
