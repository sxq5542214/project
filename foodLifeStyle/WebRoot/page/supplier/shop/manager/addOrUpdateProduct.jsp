  ...
  <body style="background-color: #eee">
    ...
    <div class="container">
      ...
      <form class="form-signup" action="supplierProduct/createOrUpdateProduct.html" method="post" enctype="multipart/form-data" onsubmit="return checkRequire()">
        ...
        <input type="number" id="product_price" name="product_price" value="<%=StringUtil.convertNull(bean.getProduct_price())%>" class="form-control" placeholder="请输入商品销售价格（分为单位）" required="required" maxlength="20" value="">
        
        <label for="product_real_price" class="sr-only" >商品市场/划线价格（分）</label>
        <input type="number" id="product_real_price" name="product_real_price" value="<%=StringUtil.convertNull(bean.getProduct_real_price())%>" class="form-control" placeholder="请输入商品市场/划线价格（分为单位）" maxlength="20" value="">
