...
String coupon_record_id = (String)request.getAttribute("coupon_record_id");
SupplierCouponConfigBean myCouponbean = (SupplierCouponConfigBean)request.getAttribute("myCouponbean");
//优惠卷id 
 int coupon_id = myCouponbean.getId();
//可以抵扣的优惠卷折扣
int coupon_discount  = myCouponbean.getCoupon_discount();
//可以抵扣的现金
int coupon_offsetmoney = myCouponbean.getCoupon_offsetmoney();
...
if(coupon_discount!=0){
 price = price * coupon_discount /10d;
}
if(coupon_offsetmoney != 0){
if(price>coupon_offsetmoney){
...
<head>
	...
	<script type="text/javascript" src="js/user/activity/coupon/orderConfirm.js"></script>
...
<input id="coupon_id" type="hidden" value="<%=myCouponbean.getId()%>">
<input id="coupon_record_id" type="hidden" value="<%=coupon_record_id%>">
