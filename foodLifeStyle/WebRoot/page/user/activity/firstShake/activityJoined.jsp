...
<script type="text/javascript" src="js/user/activity/activityJoined.js"></script>
...
<link rel="stylesheet" href="page/supplier/cardSecret/comm/share_style0_16.css">
 ...
 <script type="text/javascript">
  	weixinInit.setShareLink('<%=basePath%>activity/user/showFriendsGetActivityInfo.do?openid=<%=relation.getOpenid()%>&relation_id=<%=relation.getId()%>');
			...
			<div class="gx_wrap mt_25">
				<div class="gx_top">
					<!-- <div class="logo-40">
						...
						<p style="width: 100%;text-align: center;">您已经参加过啦！获得了<%=relation.getProduct_name() %>!</p>
...
<div class="rule-panel">
 ...
 -->
       <p style="white-space: normal;"><strong><span style="color: rgb(255, 0, 0);"></span></strong></p><p style="white-space: normal;"><br></p><p style="white-space: normal;">活动规则由商家自行定义,一般包括如下内容:</p><p style="white-space: normal;">1、活动时间</p><p style="white-space: normal;">2、活动内容</p><p style="white-space: normal;">3、参与方式</p><p style="white-space: normal;">4、活动规则</p><p style="white-space: normal;">5、奖品设置</p><p style="white-space: normal;">......</p><p><br></p>
