    ...
    var i = {
        ...
        move: function(){
        	...
        	$(".demo1").swipe( {
        		...
        		//$(this).text(dir+"-"+flagDis+"向" + direction + "滑动了" +distance+ "像素 ");
        		},
        		});
        },
        buildNavigation: function() {
            ...
            if (t) {
                var n = '<ul class="pagination pull-right" style="margin: 0px;    width: 100%;">' + '<li><a style="width: 50%;text-align: center;    padding: 8px 12px 6px 12px;" href="#" class="prev"><span class="glyphicon glyphicon-chevron-down"></span></a></li>' + '<li><a style="width: 50%;text-align: center;    padding: 8px 12px 6px 12px;" href="#" class="next"><span class="glyphicon glyphicon-chevron-up"></span></a></li>' + '</ul><div class="clearfix"></div>';
