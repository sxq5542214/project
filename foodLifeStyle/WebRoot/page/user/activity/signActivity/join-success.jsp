        ...
        <div id="resule-status-scrollWrap" style="height: 442px;">
            ...
            <div id="resule-status-head">
                <div class="resule-status-userImg one" style="border-color: rgb(181, 181, 181);">
                    <img src="page/user/activity/signActivity/images/manImg.jpg">
                </div>
                <div id="resule-status-ribbon" class="resule-status-succRibbon"></div>
            </div>
			<div id="resule-status-body">
				<p class="youraward" style="line-height:1.2rem">结果：</p>
				<p class="resule-status-minscore layerId-11 defBgColor" style=""><%=prize.getRemark() %><span class="resuleArg resulescoreLimit"></span> </p>
				<p id="bestArg" style="margin-top:0.5rem">当前积分：<span class="resuleArg"><%=user.getPoints()/100 %></span><span class="result-scoreUnit"><span class="gameScoreUnit">分</span></span></p>
