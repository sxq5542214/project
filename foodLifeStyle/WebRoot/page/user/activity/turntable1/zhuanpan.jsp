...
4.本活动奖品全部真实有效，坚果类奖品以优惠券、赠品券方式发放，可到商城中任意下单享用。<br/>
...
window.prizes = prizeStr;
	...
	weixinInit.setShareTitle("<%="预热双12！【美味坚果】和【现金红包】免费送，限量1000份，再迟就没有了！" %>");
	weixinInit.setShareDesc("<%="预热双12！【美味坚果】和【现金红包】免费送，限量1000份，再迟就没有了！" %>");
