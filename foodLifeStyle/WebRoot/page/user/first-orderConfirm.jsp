...
// double price = sp.getProduct_price()  /100d * sp.getDiscount() / 100d - NumberUtil.toInt(user.getBalance(), 0)/100d ;
double first_discount = 0.4;

//最多可用的积分 
int points = user.getPoints();
int limit_points = (int)(sp.getProduct_price() * first_discount) ;
if(points > limit_points){
	points = limit_points;
}
double price = sp.getProduct_price()  /100d * sp.getDiscount() / 100d;
//由于积分是在界面加载完成之后再从总价里减，这里要先把积分减掉
...
<head>
	...
	<script type="text/javascript" src="js/user/first-orderConfirm.js"></script>
</head>
<body class="ng-scope">
...
<div class="width320">
  ...
  <div class="menu">
    <div class="downmenu">
      <h2>支付内容：为 <span  class="ng-binding" style="color:red;" ><%=phone %></span>&nbsp;购买<span  class="ng-binding" style="color:red;"><%=sp.getProduct_name() %></span></h2>
    </div>
...
<div class="clear"></div>
<div class="menu" style="font-size: 14;padding: 10px;" >
	温馨提示：<br>
...
<input id="limit_points" type="hidden" value="<%=sp.getProduct_price() * first_discount %>">
