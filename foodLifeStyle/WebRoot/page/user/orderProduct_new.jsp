...
%>
	<div class="fb" style="height: 2rem">
    <div class="fb-lt">
    	<!-- <img src="images/scenics/scenic_3.png"> -->
        <p class="fb-name"><%=sp.getProduct_name() %></p>
        <p class="price">
        	<span class="discount"><big><%=sp.getDiscount()  %></big>折</span>
            <span class="num"><big><%=sp.getProduct_price() /100%></big>元</span>
        </p>
    </div>
</div> 
<%} %>
...
<div class="menu">
	<div>
		<table style="text-align: center;font-size: 0.7rem;width: 100%">
			<tr>
				<td width="70%">
    		<input class="accountinput" placeholder="请输入手机号码">
				</td>
				<td>
			<input value="运营商" style="color: black;" class="accountinput" readonly="readonly" >
				</td>
			</tr>
		</table>
    	...
    	<table style="text-align: center;font-size: 0.7rem;width: 100%" >
			<tr>
				<td width="70%" style="text-align: center;" >
    				<span>全民价：</span>
           			<span style="color: #ff3500;">2889</span>元
				</td>
				<td width="30%">
				<a href="javascript:;" class="hrefbtn" > 立即订购  </a>
				</td>
			</tr>
		</table>
    </div>
