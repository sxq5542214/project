...
List<UserSignBean> list = (List<UserSignBean>)request.getAttribute("list");
%>
...
<% for(UserSignBean bean : list){ %>
  <div class="menu">
    <div class="downmenu">
      <h2><span  class="ng-binding"><%=bean.getSign_date() %></span>签到获得<%=bean.getLast_points() %>积分</h2>
    </div>
<%} %>
