...
<%
	...
	List<ChannelBean> channelList = (List<ChannelBean>)request.getAttribute("list");
					...
					<table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">
                        ...
                        <% for(ChannelBean cb : channelList){
                          ...
                          <td>
                            ...
                            <td>
                              <%=cb.getDictValueByField("channel_type") %>
                            </td>
                            <td>
                              <span id="balance<%=cb.getId()%>"><%=cb.getCalc_balance()/100d %></span>
                            </td>
                            <td>
	...
	<script type="text/javascript">
      ...
      function updateCustomerStatus(){
	    ...
	    var status = $("#chose_status").val();
	      	...
	      	$.ajax({
				type : "POST",
				url : "admin/channel/updateChannelStatus.do",
				data : {"channel_id":customer_id, "status":status },
      ...
      function addCustomerBalance(){
	      ...
	      if(addBalance == ''){
	      	...
	      	$.ajax({
				type : "POST",
				url : "admin/channel/addChannelBalance.do",
				data : {"channel_id":customer_id, "add_balance":addBalance , "remark" : remark},
				success : function(data){
					if(data == "true"){
						alert("添加成功");
