				...
				<div class="widget-body">
					<div id="dt_example" class="example_alt_pagination">
						<table
							...
							<thead>
								<tr>
									<th style="width: 12%">商户名称</th>
									<th style="width: 8%">状态</th>
									<th style="width: 13%" >商户地址</th>
									<th style="width: 9%" >账户保证金</th>
							...
							<tbody>
								...
								<tr>
									<td><%=bean.getName() %></td>
									<td><%=bean.getDictValueByField("status", bean.getStatus()) %></td>
									<td><%=bean.getAddress() %></td>
									<td><%=bean.getDeposit_money() %></td>
									<td><%=bean.getBalance() %></td>
									<td><%=bean.getContacts_name() %></td>
									<td><%=bean.getContacts_phone() %></td>
									<td><button class="btn btn-default">查看可售商品</button></td>
								</tr>
								<%
								}
								%>
