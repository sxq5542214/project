...
<body style="margin: 0;">
	...
	<div class="contaniner fixed-cont" style="margin-bottom: -15%">
		<section class="go-order" >
			<div class="order-shop"   title="true" >
				<ul style="padding: 0;">
					<li>
						<span>收货人手机号：</span>
						<small><input type="text" name="contact_phone" value="<%=contactPhone %>"> </small>
					</li>
					<li>
						<span>收货人姓名：</span>
						<small><input type="text" name="contact_name" value="<%=contactName %>"> </small>
					</li>
					<li>
						<span></span>
						<small><input type="submit" value="点击查询"></small>
					</li>
				</ul>
			</div>
		</section>
