...
<title>限时福利!微信红包人人有,流量免单大放送!</title>
<meta name="description" content="限时福利!微信红包人人有,流量免单大放送!">
...
<body id="bodyDiv" style="background: white;" >
...
<div id="wrap" style="background: url();">
  <!-- 头部 -->
    <header>
	<div><img src="<%=basePath%>images/activity/freeOrderTop.jpg" alt=""  title="" ></div>
</header>
    <section>
	<div class="search" style="display: none;" id="inputPhoneDiv"  >
        ...
        <span class="inbtn2" id="grab_btn" onclick="grab()">领取流量</span>
    </div>
     <div class="search" id="scanQRCodeDiv"  >
    	<p><input name="" id="" type="text" class="input1" style="" value="长按二维码了解更多免费福利活动！" style="color: red;" readonly="readonly"></p>
     	<p>
		<%if(ticket != null){ %>
        ...
        <span class="inbtn2" id="" onclick="alert('请长按二维码关注我们，了解更多免费福利活动！')">更多免费活动</span> 
    </div>
<!--     <div class="txt1">
