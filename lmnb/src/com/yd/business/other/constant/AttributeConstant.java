...
public interface AttributeConstant {
	...
	public static final String CODE_IOT_CLIENT_QINGSONG_STATIONCODE = "iot_client_qingsong_stationcode";
	public static final String CODE_IOT_CLIENT_QINGSONG_URLPREFIX = "iot_client_qingsong_urlprefix";
...
// 支付宝相关的	
	...
	//腾讯短信接口相关  app key
	public static final String CODE_SMS_TX_APPID = "sms_tx_AppID";
	public static final String CODE_SMS_TX_APPKEY = "sms_tx_AppKey";
	public static final String CODE_SMS_TX_SECRETID = "sms_tx_SecretId";
	public static final String CODE_SMS_TX_SECRETKEY = "sms_tx_SecretKey";
	public static final String CODE_SMS_TX_SIGNNAME = "sms_tx_SignName";
