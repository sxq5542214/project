...
public class HttpUtil {
	 ...
	 * @throws Exception
	 */
	public static String post(String url,String content,List<Header> headers) throws IOException{
		CloseableHttpClient httpClient = HttpClients.createDefault();
		String result = null;
		try {
			HttpPost httpPost = new HttpPost(url); // 构造请求方式及内容
	 ...
	 * @throws Exception
	 */
	public static String postJSON(String url,String content,List<Header> headers) throws IOException{
		CloseableHttpClient httpClient = HttpClients.createDefault();
		String result = null;
		try {
			HttpPost httpPost = new HttpPost(url); // 构造请求方式及内容
			...
			CloseableHttpResponse responseBody = httpClient.execute(httpPost);
			result = EntityUtils.toString(responseBody.getEntity(),"UTF-8");
			logger.debug("httpClient response :"+ result);
		} finally{
			httpClient.close();
		}
		return result;
