...
List<ActivityWinHisBean> activityWinHisList = (List<ActivityWinHisBean>)request.getAttribute("activityWinHisList");
...
<body>
	<main data-v-49b8e837="" id="app">
		<div data-v-49b8e837="">
			...
			<%if(activityWinHisList.size() > 0){ %>
			<div data-v-7faf502c="" data-v-49b8e837="">
				<div data-v-0f850d4c="" data-v-7faf502c="" class="list-wrapper" style="height: <%=activityWinHisList.size()%>rem;">
					<%
						for(ActivityWinHisBean win : activityWinHisList){
					 %>
						...
						<div data-v-0f850d4c="">
							<div data-v-7faf502c="" class="item">
								<img data-v-163c7539="" data-v-7faf502c=""
									...
									class="text-center text-ellipsis"><%=win.getUser_name()+"&nbsp;&nbsp; 成功于"+ win.getCreate_time().substring(0,10)+"获得"+win.getPrize_name()%></span><span data-v-7faf502c="" class="text-time"></span>
							</div>
						</div>
					</div>
		...
		<div class="img-div" style="text-align: center;" >
			...
			<div data-v-ab1c5a10="" data-v-49b8e837="" class="rule-section">
				...
				<div data-v-ab1c5a10="">
					<p data-v-ab1c5a10="">
						1.人人免单攻略： <br data-v-ab1c5a10="">1）长按二维码识别并关注； <br
