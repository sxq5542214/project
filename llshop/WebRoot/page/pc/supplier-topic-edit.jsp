              ...
              <div class="col-lg-12 col-md-12">
                <div class="widget no-margin">
                  ...
                  <div class="widget-body">
                    <div class="row">
                      <form class="form-horizontal" method="post" name="form" id="articleForm" action="supplierTopic/update.do" enctype="multipart/form-data">
                      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                          <div class="form-group">
                            <label class="col-sm-3 control-label">坏人话题名称</label>
                            <div class="col-sm-9">
                              <input type="text" value="<%=StringUtil.convertNull(bean.getTitle()) %>" class="form-control" id="title" name="title" placeholder="请输入文章标题">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-sm-3 control-label">好人话题名称</label>
                            <div class="col-sm-9">
                          ...
                          <div class="form-group">
                            <label class="col-sm-3 control-label">奖品说明</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="descrip" name="descrip"
												placeholder="请输入奖品说明"  value="<%=StringUtil.convertNull(bean.getDescrip()) %>" >
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="create_time" name="create_time" 
												...
												placeholder="请输入活动开始时间"  value="<%=StringUtil.convertNull(bean.getCreate_time()) %>" >
                            </div>
                          </div>
                          <div class="form-group">
