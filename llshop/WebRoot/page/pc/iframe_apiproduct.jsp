              ...
              <div class="col-lg-12 col-md-12">
                <div class="widget">
                  ...
                  <div class="widget-body" style="text-align: right;">
							...
							<div class="stylish-lists">
								<div id="dt_example" class="example_alt_pagination">
									<table
										...
										<thead>
											<tr>
												<th style="width: 5%; text-align: center;"><input type="checkbox" class="no-margin" onclick="Api.checkAll(this);"/></th>
                  	...
                  	%>
                    <button class="btn btn-success" onclick="Api.apipro();"><i class="fa fa-check-circle-o"></i> 提交申请</button>
                  </div>
                </div>
              </div>
            </div>
