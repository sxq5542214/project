...
<%
	...
	List<SupplierTopicBean> list = pd.getDataList();
					...
					<table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">
                        ...
                        <% for(SupplierTopicBean ab : list){
                          ...
                          <td>
                            ...
                            <td>
                              <a href="<%=ab.getUrl().replaceAll("#server_url#", BaseContext.getServerUrl()) %>">链接点我</a>
                            </td>
                            <td >
                            ...
                            <td>
                                <div class="btn-group">
                                  ...
                                  <ul class="dropdown-menu pull-right">
                                    <li>
                                      <a href="<%=ab.getUrl().replaceAll("#server_url#", BaseContext.getServerUrl()) %>">预览</a>
                                    </li>
                                    <li>
                                      <a href="admin/supplierTopic/toUpdatePage.do?id=<%=ab.getId() %>">编辑</a>
                                    </li>
                                    <li>
