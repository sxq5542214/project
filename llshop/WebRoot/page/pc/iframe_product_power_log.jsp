<%@page import="com.yd.business.supplier.bean.SupplierPowerLogBean"%>
...
<%
	...
	List<SupplierPowerLogBean> list = (List<SupplierPowerLogBean>) request.getAttribute("list");
%>
<!DOCTYPE html>
<html>
  <head>
  <base href="<%=basePath%>">
<title>万大商城－商品管理-商品授权记录</title>
<meta charset="UTF-8" />
					...
					<div id="dt_example" class="example_alt_pagination">
                      <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">
                        ...
                        for(int i=0;i<list.size();i++){
                        	SupplierPowerLogBean bean = list.get(i);
                        	%>
                          ...
                          <td>
                            ...
                            <td><%=NumberUtil.toString(bean.getPower_num()) %></td>
                          </tr>
                        	<%
                        }
                        %>
