 ...
 */
@Component
public class OrderProductInstanceClient2 extends OrderProductClient{
	@Resource
	private IConfigAttributeService configAttributeService;
	
	private Logger log = Logger.getLogger(OrderProductInstanceClient2.class);
	...
	protected void initParams() {
		...
		qdid = configAttributeService.getValueByCode(AttributeConstant.CODE_DX_AH_QDID);
		qdkey = configAttributeService.getValueByCode(AttributeConstant.CODE_DX_AH_QDKEY);
	}
