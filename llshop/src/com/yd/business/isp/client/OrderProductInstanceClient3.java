 ...
 */
@Component
public class OrderProductInstanceClient3 extends OrderProductClient{
	@Resource
	private IConfigAttributeService configAttributeService;
	
	private Logger log = Logger.getLogger(OrderProductInstanceClient3.class);
	public static final String API_METHOD_JYB = "jybs4000cfm_open";
	

	protected String url ;
	protected String qdid ;
	protected String qdkey ;
	
	protected void initParams() {
		//这是阜阳电信的
		url = configAttributeService.getValueByCode(AttributeConstant.CODE_DX_AH_ORDER_URL);
		qdid = configAttributeService.getValueByCode(AttributeConstant.CODE_DX_AH_FY_QDID);
		qdkey = configAttributeService.getValueByCode(AttributeConstant.CODE_DX_AH_FY_QDKEY);
	}
...
//		String sqnid = configAttributeService.getValueByCode(AttributeConstant.CODE_DX_AH_SQNID);
		...
		bean.setType(ISPInterfaceBean.TYPE_AHDX_FY);
