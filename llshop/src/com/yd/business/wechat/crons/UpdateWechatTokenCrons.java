...
//		checkUserLastAccessDateAndSendMSG();
	...
	private void checkUserLastAccessDateAndSendMSG(){
		...
		List<UserWechatBean> users = userWechatService.queryUserBetweenLastDate(UserWechatBean.STATUS_SUBSCRIBE, startDate,endDate);

		TextBean text = new TextBean();
		String str = configAttributeService.getValueByCode(AttributeConstant.CODE_WECHAT_LONGTIME_NOACCESS);
		log.debug(" checkUserLastAccessDateAndSendMSG userList: "+ users.size());
